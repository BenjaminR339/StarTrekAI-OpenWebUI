...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($feedRaw)) {
        ...
        try {
            ...
            // ---------------------------------------------------
            $api_url = "https://garage-ai.garageisp.com/api/chat/completions";  // Updated API endpoint
            $apiKey = "sk-7e98fafb575847b6a84eaf58141ceaa8";
            ...
            $requestData = [
                ...
                "messages" => [             // Use messages array as per the new API specification
                    [
                        "role" => "You are a technical industry or market analyst from Gartner or Forrester.",
                        "content" => "Please provide concise summaries of this text, focusing on potential impacts to other vendors in competitive engagements. Please summarize the following text in 150 words or less and do not include any explanation about what you are doing, just return the summarization: " . $feedRaw
                    ]
                ]
            ];
    ...
    <body>
        ...
        <div class="form">
            <form name="form" method="post" action="">
                ...
                <p>Raw Entry</p>
                <textarea class="form-control" cols="28" rows="10" name="feedRaw" required></textarea>
                <br>
